...
/**
 * make_shash_node - makes a node hash table
 * @key: key for data
 * @value: data to  stored
 *
 * Return: pointer  new node, else NULL on failure
 */
...
/**
 * add_to_sorted_list - add a node to sorted linked list
...
/**
 * shash_table_set - sets a key to a value in hash table
...
/**
 * shash_table_get - retrieve a value from hash table
 * @ht: hash table
 * @key: key to the data
 *
